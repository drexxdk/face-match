  ...
  'inline-flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:translate-y-px touch-manipulation cursor-pointer disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-2 border-primary bg-card/70 text-primary shadow-sm hover:bg-primary hover:text-white hover:scale-[1.02] active:scale-[0.98]',
        secondary:
